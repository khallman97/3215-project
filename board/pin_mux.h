...
/*! @name PORTA12 (number 28), J1[8]/D3
  @{ */
#define BOARD_x1_GPIO GPIOA /*!<@brief GPIO device name: GPIOA */
#define BOARD_x1_PORT PORTA /*!<@brief PORT device name: PORTA */
#define BOARD_x1_PIN 12U    /*!<@brief PORTA pin index: 12 */
                            /* @} */
